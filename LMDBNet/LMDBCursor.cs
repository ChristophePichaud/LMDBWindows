...
namespace LMDBNet
{
    ...
    /// </summary>
    public class LMDBCursor : IEnumerator<KeyValuePair<byte[], byte[]>>, IEnumerable<KeyValuePair<byte[], byte[]>>
    {
        ...
        /// </summary>
        public LMDBTransaction Transaction { get; }
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (!disposing)
                throw new InvalidOperationException("The LMDBCursor was not disposed and cannot be reliably dealt with from the finalizer");

            Lmdb.mdb_cursor_close(_handle);
            _handle = IntPtr.Zero;
